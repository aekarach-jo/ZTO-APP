  ...
  Future<void> _handleSendOtp() async {
    ...
    if (success) {
      ...
      context.go(
        ...
        extra: RegisterOtpArgs(phoneNumber: phoneNumber, password: password),
      );
    }
  }
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // Play's User Data policy expects the consent to be
                          // visible where the account is actually created.
                          const PrivacyPolicyConsentText(
                            prefixKey: 'privacy_policy_consent_prefix',
                          ),
                          SizedBox(height: 4.h),
                          Align(
                            child: TextButton(
